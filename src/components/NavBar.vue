  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
            <router-link class="nav-link active" aria-current="page" :to="{name: 'userlist'}">好友列表</router-link>
        </li>
      ...
      <ul class="navbar-nav" v-if="!$store.state.user.is_login">
        ...
        <li class="nav-item">
          <router-link class="nav-link active" aria-current="page" :to="{name: 'register'}">注册</router-link>
        </li>
      </ul>
      <ul class="navbar-nav" v-else>
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" style="cursor: pointer;" @click="logout">退出</a>
        </li>
      </ul>
    </div>
  </div>
